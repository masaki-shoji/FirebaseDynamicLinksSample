...
@ActivityScoped
class DynamicLinkPresenter : DynamicLinkContract.Presenter {

    @Nullable
    private var view: DynamicLinkContract.View? = null

    private val mDynamicLinkItem: DynamicLinkItem

    private val mMapper: Mapper<DynamicLinkItem>

    private val mUseCase: DynamicLinkUseCase

    private val mAppExecutors: AppExecutors

    @Inject
    constructor(dynamicLinkItem: DynamicLinkItem,
                mapper: Mapper<DynamicLinkItem>,
                useCase: DynamicLinkUseCase,
                appExecutors: AppExecutors) {
        mDynamicLinkItem = dynamicLinkItem
        mMapper = mapper
        mUseCase = useCase
